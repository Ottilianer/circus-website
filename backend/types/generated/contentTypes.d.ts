...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    heading: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'\u00DCber uns'>;
...
export interface ApiAdmissionEntryAdmissionEntry
  extends Struct.CollectionTypeSchema {
  collectionName: 'admission_entries';
  info: {
    singularName: 'admission-entry';
    pluralName: 'admission-entries';
    displayName: 'Admission Entry';
    description: '';
  };
  options: {
    draftAndPublish: false;
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::admission-entry.admission-entry'
    > &
      Schema.Attribute.Private;
  };
}
